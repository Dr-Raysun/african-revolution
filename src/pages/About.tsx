        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-display text-4xl font-bold text-[#2D2438] mb-6">Born to Champion African Innovation</h2>
              <p className="text-[#6B5B75] leading-relaxed mb-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={label} className="p-4 rounded-sm" style={{ background: '#FAF5FF', border: '1px solid rgba(15,23,42,0.10)' }}>
                    <Icon size={14} className="mb-2" style={{ color: '#9442C8' }} />
                    <div className="text-[#7C6A86] text-xs uppercase tracking-wider mb-1">{label}</div>
                    <div className="text-[#2D2438] text-sm font-medium">{value}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 p-6 rounded-sm"
                style={{ background: '#FAF5FF', border: '1px solid rgba(148,66,200,0.3)' }}>
                <div className="font-display text-3xl font-bold" style={{ color: '#9442C8' }}>8</div>
                <div className="text-[#6B5B75] text-xs uppercase tracking-wider mt-1">Sectors Active</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 section-divider" style={{ background: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-bold text-[#2D2438] mb-4">What Guides Us</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map(({ title, desc, icon }) => (
              <div key={title}
                ...
                <h3 className="font-display text-xl font-bold text-[#2D2438] mb-3 group-hover:text-[#9442C8] transition-colors">{title}</h3>
                <p className="text-[#6B5B75] text-sm leading-relaxed">{desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-navy">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-bold text-[#2D2438] mb-4">Our Milestones</h2>
          </div>
          <div className="relative">
                ...
                <div key={year} className="flex items-start gap-8">
                  ...
                  <div className="relative flex items-start gap-6 pl-6">
                    <div className="absolute -left-2 top-2 w-4 h-4 rounded-full border-2 bg-navy"
                      style={{ borderColor: '#9442C8' }} />
                    <p className="text-[#5B4A66] leading-relaxed">{text}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-24 section-divider" style={{ background: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="font-display text-4xl font-bold text-[#2D2438] mb-6">Ready to Partner With Us?</h2>
              <p className="text-[#6B5B75] leading-relaxed mb-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/services"
                  className="inline-flex items-center gap-2 px-6 py-3 font-semibold text-sm rounded-sm transition-colors hover:text-[#9442C8]"
                  style={{ border: '1px solid rgba(15,23,42,0.20)', color: '#2D2438' }}>
                  Our Services
                </Link>
              </div>
            </div>
