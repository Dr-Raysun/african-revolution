          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 mb-6">
                ...
                <span className="text-xs font-medium tracking-widest uppercase" style={{ color: '#C9A84C' }}>Our Story</span>
              </div>
              <h2 className="font-display text-4xl font-bold text-white mb-6">Born to Champion African Innovation</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={label} className="p-4 rounded-sm" style={{ background: '#0D1F38', border: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 p-6 rounded-sm"
                ...
                <div className="text-gray-400 text-xs uppercase tracking-wider mt-1">Sectors Active</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-4">
              <div className="w-8 h-px" style={{ background: '#C9A84C' }} />
              <span className="text-xs font-medium tracking-widest uppercase" style={{ color: '#C9A84C' }}>Our Values</span>
              <div className="w-8 h-px" style={{ background: '#C9A84C' }} />
            </div>
            <h2 className="font-display text-4xl font-bold text-white mb-4">What Guides Us</h2>
          </div>
      ...
      <section className="py-24 bg-navy">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-4">
              <div className="w-8 h-px" style={{ background: '#C9A84C' }} />
              <span className="text-xs font-medium tracking-widest uppercase" style={{ color: '#C9A84C' }}>Journey</span>
              <div className="w-8 h-px" style={{ background: '#C9A84C' }} />
            </div>
            <h2 className="font-display text-4xl font-bold text-white mb-4">Our Milestones</h2>
          </div>
          <div className="relative">
            <div className="absolute left-20 top-0 bottom-0 w-px" style={{ background: 'rgba(201,168,76,0.2)' }} />
            <div className="space-y-10">
              {milestones.map(({ year, text }) => (
                <div key={year} className="flex items-start gap-8">
                  <div className="w-16 text-right shrink-0">
                    <span className="font-display font-bold" style={{ color: '#C9A84C' }}>{year}</span>
                  </div>
      ...
      <section className="py-24 section-divider" style={{ background: '#060E1C' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="font-display text-4xl font-bold text-white mb-6">Ready to Partner With Us?</h2>
              <p className="text-gray-400 leading-relaxed mb-8">
